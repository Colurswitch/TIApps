( () => {
            ...
            e.exports = (t = {
                509: (e, t, n) => {
                    function r(e, t) {
                        ...
                        return i.set(r),
                        i.set(e.data || [], r.length),
                        i
                    }
                    function s(e, t) {
                        if (e > Number.MAX_SAFE_INTEGER)
                            throw "Number too big to reliably convert";
                        const n = [];
                        for (; t > 0; )
                            t--,
                            n.push(e / Math.pow(256, t) & 255);
                        return n
                    }
                    function i(e) {
                        if (!function(e) {
                            let t = !1;
                            return (e = e.filter((e => !(0 == e && !t || (t = !0,
                            0))))).length < 7 || 7 == e.length && e[0] <= 31
                        }(e))
                            throw "Number too big to reliably convert";
                        let t = e.length
                          , n = 0
                    ...
                    e.exports = {
                        ...
                        asciiToBytes: function(e, t) {
                            ...
                            const r = new ("undefined" != typeof TextEncoder ? TextEncoder : n(790).TextEncoder)("utf-8").encode(e)
                              , s = new Uint8Array(t);
                            return s.set(r.slice(0, t)),
                            s
                        },
                        bytesToAscii: function(e) {
                            const t = e.indexOf(0);
                            return t >= 0 && (e = e.slice(0, t)),
                            new ("undefined" != typeof TextDecoder ? TextDecoder : n(790).TextDecoder)("utf-8").decode(e)
                        },
                        chunkArray: function(e, t) {
                            const n = [];
                            let r, s = 0;
                            for (r = 0; r < t.length; r++)
                                if (n.push(e.slice(s, s + t[r])),
                                s += t[r],
                                s >= e.length)
                                    return n;
                            for (r--; s < e.length; )
                                n.push(e.slice(s, s + t[r])),
                                s += t[r];
                            return n
                        }
                    }
                ...
                725: (e, t, n) => {
                    ...
                    e.exports = class {
                        ...
                        async connect() {
                            ...
                            await this._device.claimInterface(e.interfaceNumber),
                            this._inEndpoint = e.alternates[0].endpoints.find((e => "in" == e.direction)),
                            this._outEndpoint = e.alternates[0].endpoints.find((e => "out" == e.direction)),
                        ...
                        async expect(e) {
                            ...
                            if (t.type != r.rawPacketTypes.DUSB_RPKT_VIRT_DATA_LAST)
                                throw `Expected raw packet type VIRT_DATA_LAST, but got ${t.type} instead`;
                            const n = s.destructVirtualPacket(t.data);
                            switch (n.type) {
                            case e:
                                return await this._sendAck(),
                                n;
                            case r.virtualPacketTypes.DUSB_VPKT_DELAY_ACK:
                                await this._sendAck();
                                const t = s.bytesToInt(n.data);
                                return await this.wait(t / 1e3),
                                this.expect(e);
                            default:
                        ...
                        async _requestBufferSize() {
                            ...
                            if (e.type != r.rawPacketTypes.DUSB_RPKT_BUF_SIZE_ALLOC)
                                throw `Expected BUF_SIZE_ALLOC, got ${e.type} instead`;
                        ...
                        async _receive() {
                            ...
                            if ("ok" != e.status)
                                throw `Error in receiving data from device: ${e.status}`;
                        ...
                        async _expectAck() {
                            const e = s.destructRawPacket(await this._receive());
                            if (e.type != r.rawPacketTypes.DUSB_RPKT_VIRT_DATA_ACK)
                                throw `Expected ACK, got ${e.type} instead`
                        }
                    }
                }
                ,
                ...
                875: (e, t, n) => {
                    const r = n(725)
                      ...
                      , i = n(509);
                    e.exports = class {
                        constructor({device: e, properties: t}) {
                            this._d = new r(e),
                            Object.assign(this, t)
                        }
                        async connect() {
                            return await this._d.connect(),
                            this
                        }
                        canReceive(e) {
                        ...
                        async isReady() {
                            try {
                                ...
                                await this._d.expect(s.virtualPacketTypes.DUSB_VPKT_MODE_SET),
                                !0
                            } catch (e) {
                ...
                315: (e, t, n) => {
                    ...
                    function d(e) {
                        if (e || (e = "supported"),
                        !i.includes(e))
                            throw "Invalid support level selected, should be one of: " + i.join(", ");
                        if ("none" == e)
                            return s.concat(n(24));
                    ...
                    e.exports = {
                        ...
                        init: async (e={}) => {
                            ...
                            navigator.usb.addEventListener("connect", (async e => {
                                ...
                                t && u.connect.forEach((e => e(t)))
                            }
                            )),
                            navigator.usb.addEventListener("disconnect", (e => {
                                const t = a[e.device];
                                console.debug("📱 Calculator disconnected"),
                                t && u.disconnect.forEach((e => e(t)))
                            }
                            ));
                ...
                549: e => {
                    ...
                    class t {
                        ...
                        _logStep(e) {
                            this._steps.push(e),
                            this._options.verbose && console.debug(e)
                        }
                        _inject(e, t, n) {
                    ...
                    function n(e) {
                        ...
                        } : Array.isArray(e) ? e.map((e => n(e))) : "object" == typeof e ? (r = e,
                        Object.keys(r).reduce(( (e, t) => (e[t] = n(r[t]),
                        e)), {})) : JSON.parse(JSON.stringify(e)) : e;
                        var t, r
                    }
                }
                ,
    ...
    ( () => {
        ...
        function i() {
            ...
            r ? document.querySelector("#connect").classList.add("complete") : (document.querySelector("#connect").classList.add("active"),
            document.querySelector("#connect").focus()),
            s ? document.querySelector("#upload").classList.add("complete") : r && (document.querySelector("#upload").classList.add("active"),
            document.querySelector("#upload").focus()),
            r && s && (document.querySelector("#start").classList.add("active"),
            document.querySelector("#start").focus())
        }
        async function c(e) {
            await e.isReady() ? (r = e,
            i()) : d("Sorry!", "The connected device does not seem to be responding.")
        }
        function o(e) {
        ...
        function a(e, t) {
            ...
            return n.querySelector("h2").innerText = e,
            n.querySelector("p").innerText = t,
            n.querySelector(".buttons").innerHTML = "",
            n
        }
        function u(e, t, n) {
        ...
        function d(e, t) {
            return new Promise(( (n, r) => {
                ...
                s.querySelector(".buttons").appendChild(i),
        ...
        function l(e, t) {
            return new Promise(( (n, r) => {
                ...
                s.querySelector(".buttons").appendChild(i),
                s.querySelector(".buttons").appendChild(c),
                s.classList.add("active")
            }
            ))
        }
        window.ticalc = e; window.tifiles = t;
        window.addEventListener("load", ( () => {
            ...
            e.addEventListener("connect", (async e => "experimental" == e.status || "beta" == e.status ? l("Be careful!", `Your device (${e.name}) only has ${e.status} support. Are you sure you want to continue?`).then(( () => c(e))).catch(( () => {}
            )) : c(e))),
            i(),
            document.querySelector("#connect").addEventListener("click", ( () => e.choose().catch((e => o(e))))),
            document.querySelector("#upload").addEventListener("click", ( () => function() {
                const e = document.createElement("input");
                e.type = "file",
                e.accept = ".8xp,.8xg,.83p,.83g,.82p,.82g",
                e.addEventListener("change", (async e => {
                    if (s = t.parseFile(await function(e) {
                        return new Promise(( (t, n) => {
                    ...
                    console.log(s),
                    t.isValid(s) || (s = null,
                    d("Sorry!", "The file you have selected does not seem to be a valid calculator file")),
                    r && !r.canReceive(s))
                        return d("Careful!", `The file you have selected does not appear to be a valid file for your ${r.name}.`);
                    i()
                }
                )),
                e.click()
            ...
            document.querySelector("#start").addEventListener("click", ( () => async function() {
                if (r && s) {
                    if (!r.canReceive(s))
                        return d("Sorry!", `The file you have selected does not appear to be a valid file for your ${r.name}.`);
                    if (!(await r.getStorageDetails(s)).fits)
                        return d("Sorry!", "Your calculator does not have enough free memory to receive this file.");
                    try {
                        await r.sendFile(s),
            ...
            document.querySelector("#incompatible").classList.remove("active")) : (document.querySelector("#flow").classList.remove("active"),
